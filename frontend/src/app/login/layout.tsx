...
export default function LoginLayout({
    ...
    return (
    <main className="flex w-full justify-center select-none transition-all min-h-400px sticky overflow-y-clip">
        <motion.div className='m-16 overflow-hidden w-[600px] min-w-[350px] max-w-[900px] lg:w-[80%] min-h-[34rem] rounded-3xl flex justify-center items-center lg:justify-normal z-0 bg-black border-2 lg:border-black md:min-h-[34rem]' initial={{opacity: 0}} animate={{opacity:1}} exit={{opacity:0}}>
